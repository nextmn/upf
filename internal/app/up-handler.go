...
func ipPacketHandler(packet []byte, db *FARAssociationDB, iface *water.Interface, pfcpServer *pfcp_networking.PFCPEntityUP) error {
	...
	handleIncommingPacket(db, packet, false, pfcpSession, pdr, iface)
	return nil
}
